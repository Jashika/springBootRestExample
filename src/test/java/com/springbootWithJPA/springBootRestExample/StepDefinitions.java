...
public class StepDefinitions {
  ...
  @Given("I have specified endpoint")
   ...
   @Given("Employee object to be updated")
    ...
    public void i_send_a_request_with_the_values_and_id_an_employee_with_specified_id_is_updated_in_db(int id) {
    ...
    public void i_should_see_the_updated_employee_object_from_db_as_response() {
       assertNotNull(emp);
    }
  @Given("I have specified an employee id={int} which has to be deleted")
    public void i_have_specified_an_employee_id_which_has_to_be_deleted(int id) {
    ...
    public void i_should_see_the_employee_object_deleted_from_db(int id) {
        employees=springBootRestExampleIntegrationTest.getEmployees();
